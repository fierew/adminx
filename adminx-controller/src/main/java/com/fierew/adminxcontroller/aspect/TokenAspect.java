package com.fierew.adminxcontroller.aspect;
...
public class TokenAspect {
     ...
     */
    @Pointcut("execution( * com.fierew.adminxcontroller.controller..*.*(..)) || " +
            "execution(public * com.fierew.adminxcontroller.controller..*.*(..)) || " +
            "execution( * com.fierew.adminxrbac.controller..*.*(..)) || " +
            "execution(public * com.fierew.adminxrbac.controller..*.*(..))"
    )
